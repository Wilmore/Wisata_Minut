...
import { DefaultHeader as DH, HomeButton } from '../../assets';
import { Button, Gap } from '../../components';

const DefaultView = ({navigation}) => {
  return (
    <ScrollView style={styles.container}>
      <Image source={DH} resizeMode='cover'/>
      <Text style={styles.Text1}>Default Title</Text>
      ...
      <View style={styles.Wrapper2}>
        ...
        <View style={styles.backround}>
          <Text style={styles.textprice}>00000</Text>
        </View>
