...
import {HomeButton, PantaiMangketView as PM} from '../../assets';
import { Button, Gap } from '../../components';

const PMangketView = ({navigation}) => {
  return (
    <ScrollView style={styles.container}>
      <Image source={PM} resizeMode='cover'/>
      <Text style={styles.Text1}>Pantai Mangket</Text>

         <View style={styles.btn}>
          <Button title="Akomodasi" style={{padding: 50}} onPress={()=>navigation.navigate('DefaultAkomodasi')}/>
          <Button title="Lokasi" onPress={ ()=>{ Linking.openURL('https://www.google.com/maps/place/Pantai+Mangket/@1.2955768,125.0585112,15z/data=!4m5!3m4!1s0x32871996bdb39e97:0xf96ff433e1123c2e!8m2!3d1.2955769!4d125.067266')}} />
        </View>
